...
SIGNAL \DECODER_BLOCKS|Equal6~2_combout\ : std_logic;
...
SIGNAL \DECODER_BLOCKS|Equal6~1_combout\ : std_logic;
SIGNAL \DECODER_BLOCKS|Equal6~0_combout\ : std_logic;
SIGNAL \DECODER_BLOCKS|SAIDA[5]~0_combout\ : std_logic;
...
SIGNAL \DECODER_BLOCKS|ALT_INV_Equal6~3_combout\ : std_logic;
SIGNAL \DECODER_BLOCKS|ALT_INV_Equal6~2_combout\ : std_logic;
...
\DECODER_BLOCKS|ALT_INV_Equal6~3_combout\ <= NOT \DECODER_BLOCKS|Equal6~3_combout\;
\DECODER_BLOCKS|ALT_INV_Equal6~2_combout\ <= NOT \DECODER_BLOCKS|Equal6~2_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \DECODER_BLOCKS|Equal6~3_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \DECODER_BLOCKS|Equal6~2_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \DECODER_BLOCKS|Equal6~1_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \DECODER_BLOCKS|Equal6~0_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \DECODER_BLOCKS|SAIDA[5]~0_combout\,
	devoe => ww_devoe,
...
-- Equation(s):
-- \ROM|memROM~12_combout\ = (!\CPU|INSTR|PC|DOUT\(0) & ((!\CPU|INSTR|PC|DOUT\(2) $ (!\CPU|INSTR|PC|DOUT\(3))))) # (\CPU|INSTR|PC|DOUT\(0) & (!\CPU|INSTR|PC|DOUT\(3) & ((!\CPU|INSTR|PC|DOUT\(1)) # (!\CPU|INSTR|PC|DOUT\(2)))))
...
-- Equation(s):
-- \ROM|memROM~13_combout\ = (\ROM|memROM~5_combout\ & \ROM|memROM~12_combout\)
...
-- Equation(s):
-- \ROM|memROM~14_combout\ = (\CPU|INSTR|PC|DOUT\(1) & (!\CPU|INSTR|PC|DOUT\(2) & (!\CPU|INSTR|PC|DOUT\(0) $ (\CPU|INSTR|PC|DOUT\(3)))))
...
-- Equation(s):
-- \ROM|memROM~16_combout\ = (!\CPU|INSTR|PC|DOUT\(3) & (!\CPU|INSTR|PC|DOUT\(0) & (!\CPU|INSTR|PC|DOUT\(1) $ (!\CPU|INSTR|PC|DOUT\(2))))) # (\CPU|INSTR|PC|DOUT\(3) & (((\CPU|INSTR|PC|DOUT\(2)))))
...
-- Equation(s):
-- \ROM|memROM~17_combout\ = (\ROM|memROM~5_combout\ & !\ROM|memROM~16_combout\)
...
-- Equation(s):
-- \CPU|LOG_DESVIO|DESV_JUMP[0]~0_combout\ = (\ROM|memROM~1_combout\ & (!\ROM|memROM~13_combout\ & (\ROM|memROM~14_combout\ & \ROM|memROM~17_combout\)))
...
-- Equation(s):
-- \ROM|memROM~8_combout\ = (\CPU|INSTR|PC|DOUT\(0) & (!\CPU|INSTR|PC|DOUT\(2) & (\CPU|INSTR|PC|DOUT\(3) & \ROM|memROM~5_combout\)))
...
-- Equation(s):
-- \ROM|memROM~9_combout\ = ( \ROM|memROM~5_combout\ & ( (\CPU|INSTR|PC|DOUT\(0) & (!\CPU|INSTR|PC|DOUT\(1) & (!\CPU|INSTR|PC|DOUT\(2) & \CPU|INSTR|PC|DOUT\(3)))) ) )
...
-- Equation(s):
-- \ROM|memROM~10_combout\ = (!\CPU|INSTR|PC|DOUT\(2) & (!\CPU|INSTR|PC|DOUT\(0) & ((\CPU|INSTR|PC|DOUT\(3))))) # (\CPU|INSTR|PC|DOUT\(2) & (!\CPU|INSTR|PC|DOUT\(3) & (!\CPU|INSTR|PC|DOUT\(0) $ (!\CPU|INSTR|PC|DOUT\(1)))))
...
-- Equation(s):
-- \ROM|memROM~11_combout\ = (\ROM|memROM~5_combout\ & \ROM|memROM~10_combout\)
...
-- Equation(s):
-- \ROM|memROM~6_combout\ = (\CPU|INSTR|PC|DOUT\(1) & (\CPU|INSTR|PC|DOUT\(2) & !\CPU|INSTR|PC|DOUT\(3)))
...
-- Equation(s):
-- \ROM|memROM~7_combout\ = (\CPU|INSTR|PC|DOUT\(0) & (\ROM|memROM~5_combout\ & \ROM|memROM~6_combout\))
...
-- Equation(s):
-- \ROM|memROM~15_combout\ = (!\CPU|INSTR|PC|DOUT\(8) & (\ROM|memROM~1_combout\ & \ROM|memROM~14_combout\))
...
-- Equation(s):
-- \CPU|DECODER|Equal10~1_combout\ = (!\ROM|memROM~13_combout\ & (!\ROM|memROM~15_combout\ & \ROM|memROM~17_combout\))
...
-- Equation(s):
-- \CPU|DECODER|sinais_controle~0_combout\ = ( \ROM|memROM~16_combout\ & ( (!\CPU|INSTR|PC|DOUT\(8) & (\ROM|memROM~1_combout\ & ((\ROM|memROM~14_combout\) # (\ROM|memROM~12_combout\)))) ) )
...
\DECODER_BLOCKS|Equal6~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER_BLOCKS|Equal6~2_combout\ = ( \CPU|INSTR|PC|DOUT\(0) & ( (!\ROM|memROM~5_combout\) # ((!\CPU|INSTR|PC|DOUT\(3) & (!\CPU|INSTR|PC|DOUT\(2))) # (\CPU|INSTR|PC|DOUT\(3) & ((\CPU|INSTR|PC|DOUT\(1)) # (\CPU|INSTR|PC|DOUT\(2))))) ) ) # ( 
-- !\CPU|INSTR|PC|DOUT\(0) & ( (!\ROM|memROM~5_combout\) # ((!\CPU|INSTR|PC|DOUT\(3) & ((!\CPU|INSTR|PC|DOUT\(2)) # (!\CPU|INSTR|PC|DOUT\(1)))) # (\CPU|INSTR|PC|DOUT\(3) & (\CPU|INSTR|PC|DOUT\(2)))) ) )
...
PORT MAP (
	...
	combout => \DECODER_BLOCKS|Equal6~2_combout\);

\RAM|dado_out~8\ : cyclonev_lcell_comb
-- Equation(s):
-- \RAM|dado_out~8_combout\ = (\CPU|DECODER|sinais_controle~0_combout\ & \DECODER_BLOCKS|Equal6~2_combout\)
...
PORT MAP (
	...
	datab => \DECODER_BLOCKS|ALT_INV_Equal6~2_combout\,
	combout => \RAM|dado_out~8_combout\);

\RAM|dado_out[0]~9\ : cyclonev_lcell_comb
-- Equation(s):
-- \RAM|dado_out[0]~9_combout\ = (!\RAM|dado_out~8_combout\) # ((!\ROM|memROM~7_combout\ & \RAM|ram~529_combout\))
...
-- Equation(s):
-- \ROM|memROM~18_combout\ = (\ROM|memROM~0_combout\ & \ROM|memROM~1_combout\)
...
-- Equation(s):
-- \CPU|ULA1|Add0~1_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & (((\RAM|dado_out[0]~9_combout\)))) # (\CPU|DECODER|Equal10~1_combout\ & (!\CPU|INSTR|PC|DOUT\(8) & ((\ROM|memROM~18_combout\)))) ) + ( \CPU|REG_A|DOUT\(0) ) + ( !VCC ))
-- \CPU|ULA1|Add0~2\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & (((\RAM|dado_out[0]~9_combout\)))) # (\CPU|DECODER|Equal10~1_combout\ & (!\CPU|INSTR|PC|DOUT\(8) & ((\ROM|memROM~18_combout\)))) ) + ( \CPU|REG_A|DOUT\(0) ) + ( !VCC ))
...
-- Equation(s):
-- \CPU|DECODER|sinais_controle~1_combout\ = (!\ROM|memROM~15_combout\ & (!\ROM|memROM~13_combout\ $ (!\ROM|memROM~17_combout\)))
...
-- Equation(s):
-- \CPU|ULA1|Add1~1_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & (!\RAM|dado_out[0]~9_combout\)) # (\CPU|DECODER|Equal10~1_combout\ & (((!\ROM|memROM~18_combout\) # (\CPU|INSTR|PC|DOUT\(8))))) ) + ( \CPU|REG_A|DOUT\(0) ) + ( \CPU|ULA1|Add1~34_cout\ ))
-- \CPU|ULA1|Add1~2\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & (!\RAM|dado_out[0]~9_combout\)) # (\CPU|DECODER|Equal10~1_combout\ & (((!\ROM|memROM~18_combout\) # (\CPU|INSTR|PC|DOUT\(8))))) ) + ( \CPU|REG_A|DOUT\(0) ) + ( \CPU|ULA1|Add1~34_cout\ ))
...
-- Equation(s):
-- \CPU|ULA1|saida[0]~0_combout\ = ( \CPU|ULA1|Add1~1_sumout\ & ( (!\CPU|DECODER|sinais_controle~1_combout\) # ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[0]~9_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~2_combout\))) ) ) # ( 
-- !\CPU|ULA1|Add1~1_sumout\ & ( (\CPU|DECODER|sinais_controle~1_combout\ & ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[0]~9_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~2_combout\)))) ) )
...
-- Equation(s):
-- \CPU|DECODER|Equal10~2_combout\ = ((!\ROM|memROM~15_combout\) # (\ROM|memROM~17_combout\)) # (\ROM|memROM~13_combout\)
...
-- Equation(s):
-- \CPU|DECODER|sinais_controle~2_combout\ = !\ROM|memROM~17_combout\ $ (((!\ROM|memROM~13_combout\ & !\ROM|memROM~15_combout\)))
...
-- Equation(s):
-- \CPU|DECODER|Equal10~0_combout\ = ( !\ROM|memROM~16_combout\ & ( (!\CPU|INSTR|PC|DOUT\(8) & (\ROM|memROM~1_combout\ & (\ROM|memROM~12_combout\ & !\ROM|memROM~14_combout\))) ) )
...
-- Equation(s):
-- \RAM|ram~561_combout\ = ( \DECODER_BLOCKS|Equal6~2_combout\ & ( \CPU|DECODER|Equal10~0_combout\ & ( (!\ROM|memROM~2_combout\ & (!\ROM|memROM~4_combout\ & (!\ROM|memROM~7_combout\ & !\ROM|memROM~8_combout\))) ) ) )
...
PORT MAP (
	...
	datae => \DECODER_BLOCKS|ALT_INV_Equal6~2_combout\,
	dataf => \CPU|DECODER|ALT_INV_Equal10~0_combout\,
...
-- Equation(s):
-- \RAM|ram~560_combout\ = ( \DECODER_BLOCKS|Equal6~2_combout\ & ( \CPU|DECODER|Equal10~0_combout\ & ( (\ROM|memROM~2_combout\ & (!\ROM|memROM~4_combout\ & (!\ROM|memROM~7_combout\ & !\ROM|memROM~8_combout\))) ) ) )
...
-- Equation(s):
-- \RAM|ram~527_combout\ = ( !\ROM|memROM~8_combout\ & ( \ROM|memROM~2_combout\ & ( \RAM|ram~23_q\ ) ) ) # ( !\ROM|memROM~8_combout\ & ( !\ROM|memROM~2_combout\ & ( \RAM|ram~15_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~559_combout\ = ( \DECODER_BLOCKS|Equal6~2_combout\ & ( \CPU|DECODER|Equal10~0_combout\ & ( (!\ROM|memROM~2_combout\ & (\ROM|memROM~4_combout\ & (!\ROM|memROM~7_combout\ & !\ROM|memROM~8_combout\))) ) ) )
...
-- Equation(s):
-- \RAM|ram~528_combout\ = ( !\ROM|memROM~8_combout\ & ( !\ROM|memROM~2_combout\ & ( \RAM|ram~31_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~529_combout\ = ( \ROM|memROM~4_combout\ & ( !\ROM|memROM~9_combout\ & ( \RAM|ram~528_combout\ ) ) ) # ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~9_combout\ & ( \RAM|ram~527_combout\ ) ) )
...
-- Equation(s):
-- \RAM|ram~551_combout\ = (!\ROM|memROM~7_combout\ & \RAM|ram~529_combout\)
...
-- Equation(s):
-- \RAM|dado_out[1]~10_combout\ = (!\RAM|dado_out~8_combout\) # ((!\ROM|memROM~7_combout\ & \RAM|ram~532_combout\))
...
-- Equation(s):
-- \ROM|memROM~19_combout\ = (\ROM|memROM~1_combout\ & \ROM|memROM~3_combout\)
...
-- Equation(s):
-- \CPU|ULA1|Add0~5_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & (((\RAM|dado_out[1]~10_combout\)))) # (\CPU|DECODER|Equal10~1_combout\ & (!\CPU|INSTR|PC|DOUT\(8) & ((\ROM|memROM~19_combout\)))) ) + ( \CPU|REG_A|DOUT\(1) ) + ( \CPU|ULA1|Add0~2\ ))
-- \CPU|ULA1|Add0~6\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & (((\RAM|dado_out[1]~10_combout\)))) # (\CPU|DECODER|Equal10~1_combout\ & (!\CPU|INSTR|PC|DOUT\(8) & ((\ROM|memROM~19_combout\)))) ) + ( \CPU|REG_A|DOUT\(1) ) + ( \CPU|ULA1|Add0~2\ ))
...
-- Equation(s):
-- \CPU|ULA1|Add1~5_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & (!\RAM|dado_out[1]~10_combout\)) # (\CPU|DECODER|Equal10~1_combout\ & (((!\ROM|memROM~19_combout\) # (\CPU|INSTR|PC|DOUT\(8))))) ) + ( \CPU|REG_A|DOUT\(1) ) + ( \CPU|ULA1|Add1~2\ ))
-- \CPU|ULA1|Add1~6\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & (!\RAM|dado_out[1]~10_combout\)) # (\CPU|DECODER|Equal10~1_combout\ & (((!\ROM|memROM~19_combout\) # (\CPU|INSTR|PC|DOUT\(8))))) ) + ( \CPU|REG_A|DOUT\(1) ) + ( \CPU|ULA1|Add1~2\ ))
...
PORT MAP (
	dataa => \CPU|DECODER|ALT_INV_Equal10~1_combout\,
	datab => \RAM|ALT_INV_dado_out[1]~10_combout\,
	datac => \CPU|INSTR|PC|ALT_INV_DOUT\(8),
	datad => \ROM|ALT_INV_memROM~19_combout\,
	dataf => \CPU|REG_A|ALT_INV_DOUT\(1),
	cin => \CPU|ULA1|Add1~2\,
...
-- Equation(s):
-- \CPU|ULA1|saida[1]~1_combout\ = ( \CPU|ULA1|Add1~5_sumout\ & ( (!\CPU|DECODER|sinais_controle~1_combout\) # ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[1]~10_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~4_combout\))) ) ) # ( 
-- !\CPU|ULA1|Add1~5_sumout\ & ( (\CPU|DECODER|sinais_controle~1_combout\ & ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[1]~10_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~4_combout\)))) ) )
...
-- Equation(s):
-- \RAM|ram~530_combout\ = ( \ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~32_q\ ) ) ) # ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~16_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~531_combout\ = ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~24_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~532_combout\ = ( !\ROM|memROM~9_combout\ & ( \ROM|memROM~2_combout\ & ( \RAM|ram~531_combout\ ) ) ) # ( !\ROM|memROM~9_combout\ & ( !\ROM|memROM~2_combout\ & ( \RAM|ram~530_combout\ ) ) )
...
-- Equation(s):
-- \RAM|ram~552_combout\ = (!\ROM|memROM~7_combout\ & \RAM|ram~532_combout\)
...
-- Equation(s):
-- \RAM|dado_out[2]~11_combout\ = (!\RAM|dado_out~8_combout\) # ((!\ROM|memROM~7_combout\ & \RAM|ram~535_combout\))
...
-- Equation(s):
-- \CPU|ULA1|Add0~9_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[2]~11_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~7_combout\)) ) + ( \CPU|REG_A|DOUT\(2) ) + ( \CPU|ULA1|Add0~6\ ))
-- \CPU|ULA1|Add0~10\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[2]~11_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~7_combout\)) ) + ( \CPU|REG_A|DOUT\(2) ) + ( \CPU|ULA1|Add0~6\ ))
...
-- Equation(s):
-- \CPU|ULA1|Add1~9_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & ((!\RAM|dado_out[2]~11_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (!\ROM|memROM~7_combout\)) ) + ( \CPU|REG_A|DOUT\(2) ) + ( \CPU|ULA1|Add1~6\ ))
-- \CPU|ULA1|Add1~10\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & ((!\RAM|dado_out[2]~11_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (!\ROM|memROM~7_combout\)) ) + ( \CPU|REG_A|DOUT\(2) ) + ( \CPU|ULA1|Add1~6\ ))
...
-- Equation(s):
-- \CPU|ULA1|saida[2]~2_combout\ = ( \CPU|ULA1|Add1~9_sumout\ & ( (!\CPU|DECODER|sinais_controle~1_combout\) # ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[2]~11_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~7_combout\))) ) ) # ( 
-- !\CPU|ULA1|Add1~9_sumout\ & ( (\CPU|DECODER|sinais_controle~1_combout\ & ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[2]~11_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~7_combout\)))) ) )
...
-- Equation(s):
-- \RAM|ram~533_combout\ = ( \ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~33_q\ ) ) ) # ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~17_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~534_combout\ = ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~25_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~535_combout\ = ( !\ROM|memROM~9_combout\ & ( \ROM|memROM~2_combout\ & ( \RAM|ram~534_combout\ ) ) ) # ( !\ROM|memROM~9_combout\ & ( !\ROM|memROM~2_combout\ & ( \RAM|ram~533_combout\ ) ) )
...
-- Equation(s):
-- \RAM|ram~553_combout\ = (!\ROM|memROM~7_combout\ & \RAM|ram~535_combout\)
...
-- Equation(s):
-- \RAM|dado_out[3]~12_combout\ = (!\RAM|dado_out~8_combout\) # ((!\ROM|memROM~7_combout\ & \RAM|ram~538_combout\))
...
-- Equation(s):
-- \CPU|ULA1|Add0~13_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[3]~12_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~8_combout\)) ) + ( \CPU|REG_A|DOUT\(3) ) + ( \CPU|ULA1|Add0~10\ ))
-- \CPU|ULA1|Add0~14\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[3]~12_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~8_combout\)) ) + ( \CPU|REG_A|DOUT\(3) ) + ( \CPU|ULA1|Add0~10\ ))
...
-- Equation(s):
-- \CPU|ULA1|Add1~13_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & ((!\RAM|dado_out[3]~12_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (!\ROM|memROM~8_combout\)) ) + ( \CPU|REG_A|DOUT\(3) ) + ( \CPU|ULA1|Add1~10\ ))
-- \CPU|ULA1|Add1~14\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & ((!\RAM|dado_out[3]~12_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (!\ROM|memROM~8_combout\)) ) + ( \CPU|REG_A|DOUT\(3) ) + ( \CPU|ULA1|Add1~10\ ))
...
-- Equation(s):
-- \CPU|ULA1|saida[3]~3_combout\ = ( \CPU|ULA1|Add1~13_sumout\ & ( (!\CPU|DECODER|sinais_controle~1_combout\) # ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[3]~12_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~8_combout\))) ) ) # ( 
-- !\CPU|ULA1|Add1~13_sumout\ & ( (\CPU|DECODER|sinais_controle~1_combout\ & ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[3]~12_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~8_combout\)))) ) )
...
-- Equation(s):
-- \RAM|ram~536_combout\ = ( \ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~34_q\ ) ) ) # ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~18_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~537_combout\ = ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~26_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~538_combout\ = ( !\ROM|memROM~9_combout\ & ( \ROM|memROM~2_combout\ & ( \RAM|ram~537_combout\ ) ) ) # ( !\ROM|memROM~9_combout\ & ( !\ROM|memROM~2_combout\ & ( \RAM|ram~536_combout\ ) ) )
...
-- Equation(s):
-- \RAM|ram~554_combout\ = (!\ROM|memROM~7_combout\ & \RAM|ram~538_combout\)
...
-- Equation(s):
-- \RAM|dado_out[4]~13_combout\ = (!\RAM|dado_out~8_combout\) # ((!\ROM|memROM~7_combout\ & \RAM|ram~541_combout\))
...
-- Equation(s):
-- \CPU|ULA1|Add0~17_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[4]~13_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~7_combout\)) ) + ( \CPU|REG_A|DOUT\(4) ) + ( \CPU|ULA1|Add0~14\ ))
-- \CPU|ULA1|Add0~18\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[4]~13_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~7_combout\)) ) + ( \CPU|REG_A|DOUT\(4) ) + ( \CPU|ULA1|Add0~14\ ))
...
-- Equation(s):
-- \CPU|ULA1|Add1~17_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & ((!\RAM|dado_out[4]~13_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (!\ROM|memROM~7_combout\)) ) + ( \CPU|REG_A|DOUT\(4) ) + ( \CPU|ULA1|Add1~14\ ))
-- \CPU|ULA1|Add1~18\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & ((!\RAM|dado_out[4]~13_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (!\ROM|memROM~7_combout\)) ) + ( \CPU|REG_A|DOUT\(4) ) + ( \CPU|ULA1|Add1~14\ ))
...
-- Equation(s):
-- \CPU|ULA1|saida[4]~4_combout\ = ( \CPU|ULA1|Add1~17_sumout\ & ( (!\CPU|DECODER|sinais_controle~1_combout\) # ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[4]~13_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~7_combout\))) ) ) # ( 
-- !\CPU|ULA1|Add1~17_sumout\ & ( (\CPU|DECODER|sinais_controle~1_combout\ & ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[4]~13_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~7_combout\)))) ) )
...
-- Equation(s):
-- \RAM|ram~539_combout\ = ( \ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~35_q\ ) ) ) # ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~19_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~540_combout\ = ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~27_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~541_combout\ = ( !\ROM|memROM~9_combout\ & ( \ROM|memROM~2_combout\ & ( \RAM|ram~540_combout\ ) ) ) # ( !\ROM|memROM~9_combout\ & ( !\ROM|memROM~2_combout\ & ( \RAM|ram~539_combout\ ) ) )
...
-- Equation(s):
-- \RAM|ram~555_combout\ = (!\ROM|memROM~7_combout\ & \RAM|ram~541_combout\)
...
-- Equation(s):
-- \RAM|dado_out[5]~14_combout\ = (!\RAM|dado_out~8_combout\) # ((!\ROM|memROM~7_combout\ & \RAM|ram~544_combout\))
...
-- Equation(s):
-- \CPU|ULA1|Add0~21_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[5]~14_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~9_combout\)) ) + ( \CPU|REG_A|DOUT\(5) ) + ( \CPU|ULA1|Add0~18\ ))
-- \CPU|ULA1|Add0~22\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[5]~14_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~9_combout\)) ) + ( \CPU|REG_A|DOUT\(5) ) + ( \CPU|ULA1|Add0~18\ ))
...
-- Equation(s):
-- \CPU|ULA1|Add1~21_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & ((!\RAM|dado_out[5]~14_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (!\ROM|memROM~9_combout\)) ) + ( \CPU|REG_A|DOUT\(5) ) + ( \CPU|ULA1|Add1~18\ ))
-- \CPU|ULA1|Add1~22\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & ((!\RAM|dado_out[5]~14_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (!\ROM|memROM~9_combout\)) ) + ( \CPU|REG_A|DOUT\(5) ) + ( \CPU|ULA1|Add1~18\ ))
...
-- Equation(s):
-- \CPU|ULA1|saida[5]~5_combout\ = ( \CPU|ULA1|Add1~21_sumout\ & ( (!\CPU|DECODER|sinais_controle~1_combout\) # ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[5]~14_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~9_combout\))) ) ) # ( 
-- !\CPU|ULA1|Add1~21_sumout\ & ( (\CPU|DECODER|sinais_controle~1_combout\ & ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[5]~14_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~9_combout\)))) ) )
...
-- Equation(s):
-- \RAM|ram~542_combout\ = ( \ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~36_q\ ) ) ) # ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~20_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~543_combout\ = ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~28_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~544_combout\ = ( !\ROM|memROM~9_combout\ & ( \ROM|memROM~2_combout\ & ( \RAM|ram~543_combout\ ) ) ) # ( !\ROM|memROM~9_combout\ & ( !\ROM|memROM~2_combout\ & ( \RAM|ram~542_combout\ ) ) )
...
-- Equation(s):
-- \RAM|ram~556_combout\ = (!\ROM|memROM~7_combout\ & \RAM|ram~544_combout\)
...
-- Equation(s):
-- \RAM|dado_out[6]~15_combout\ = (!\RAM|dado_out~8_combout\) # ((!\ROM|memROM~7_combout\ & \RAM|ram~547_combout\))
...
-- Equation(s):
-- \CPU|ULA1|Add0~25_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[6]~15_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~7_combout\)) ) + ( \CPU|REG_A|DOUT\(6) ) + ( \CPU|ULA1|Add0~22\ ))
-- \CPU|ULA1|Add0~26\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[6]~15_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~7_combout\)) ) + ( \CPU|REG_A|DOUT\(6) ) + ( \CPU|ULA1|Add0~22\ ))
...
-- Equation(s):
-- \CPU|ULA1|Add1~25_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & ((!\RAM|dado_out[6]~15_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (!\ROM|memROM~7_combout\)) ) + ( \CPU|REG_A|DOUT\(6) ) + ( \CPU|ULA1|Add1~22\ ))
-- \CPU|ULA1|Add1~26\ = CARRY(( (!\CPU|DECODER|Equal10~1_combout\ & ((!\RAM|dado_out[6]~15_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (!\ROM|memROM~7_combout\)) ) + ( \CPU|REG_A|DOUT\(6) ) + ( \CPU|ULA1|Add1~22\ ))
...
-- Equation(s):
-- \CPU|ULA1|saida[6]~6_combout\ = ( \CPU|ULA1|Add1~25_sumout\ & ( (!\CPU|DECODER|sinais_controle~1_combout\) # ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[6]~15_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~7_combout\))) ) ) # ( 
-- !\CPU|ULA1|Add1~25_sumout\ & ( (\CPU|DECODER|sinais_controle~1_combout\ & ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[6]~15_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~7_combout\)))) ) )
...
-- Equation(s):
-- \RAM|ram~545_combout\ = ( \ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~37_q\ ) ) ) # ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~21_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~546_combout\ = ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~29_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~547_combout\ = ( !\ROM|memROM~9_combout\ & ( \ROM|memROM~2_combout\ & ( \RAM|ram~546_combout\ ) ) ) # ( !\ROM|memROM~9_combout\ & ( !\ROM|memROM~2_combout\ & ( \RAM|ram~545_combout\ ) ) )
...
-- Equation(s):
-- \RAM|ram~557_combout\ = (!\ROM|memROM~7_combout\ & \RAM|ram~547_combout\)
...
-- Equation(s):
-- \RAM|dado_out[7]~16_combout\ = (!\RAM|dado_out~8_combout\) # ((!\ROM|memROM~7_combout\ & \RAM|ram~550_combout\))
...
-- Equation(s):
-- \CPU|ULA1|Add0~29_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[7]~16_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~9_combout\)) ) + ( \CPU|REG_A|DOUT\(7) ) + ( \CPU|ULA1|Add0~26\ ))
...
-- Equation(s):
-- \CPU|ULA1|Add1~29_sumout\ = SUM(( (!\CPU|DECODER|Equal10~1_combout\ & ((!\RAM|dado_out[7]~16_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (!\ROM|memROM~9_combout\)) ) + ( \CPU|REG_A|DOUT\(7) ) + ( \CPU|ULA1|Add1~26\ ))
...
-- Equation(s):
-- \CPU|ULA1|saida[7]~7_combout\ = ( \CPU|ULA1|Add1~29_sumout\ & ( (!\CPU|DECODER|sinais_controle~1_combout\) # ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[7]~16_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~9_combout\))) ) ) # ( 
-- !\CPU|ULA1|Add1~29_sumout\ & ( (\CPU|DECODER|sinais_controle~1_combout\ & ((!\CPU|DECODER|Equal10~1_combout\ & ((\RAM|dado_out[7]~16_combout\))) # (\CPU|DECODER|Equal10~1_combout\ & (\ROM|memROM~9_combout\)))) ) )
...
-- Equation(s):
-- \RAM|ram~548_combout\ = ( \ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~38_q\ ) ) ) # ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~22_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~549_combout\ = ( !\ROM|memROM~4_combout\ & ( !\ROM|memROM~8_combout\ & ( \RAM|ram~30_q\ ) ) )
...
-- Equation(s):
-- \RAM|ram~550_combout\ = ( !\ROM|memROM~9_combout\ & ( \ROM|memROM~2_combout\ & ( \RAM|ram~549_combout\ ) ) ) # ( !\ROM|memROM~9_combout\ & ( !\ROM|memROM~2_combout\ & ( \RAM|ram~548_combout\ ) ) )
...
-- Equation(s):
-- \RAM|ram~558_combout\ = (!\ROM|memROM~7_combout\ & \RAM|ram~550_combout\)
...
-- Equation(s):
-- \DECODER_ADDR|Equal6~0_combout\ = ( \ROM|memROM~3_combout\ & ( \ROM|memROM~6_combout\ & ( (!\ROM|memROM~1_combout\) # (\CPU|INSTR|PC|DOUT\(8)) ) ) ) # ( !\ROM|memROM~3_combout\ & ( \ROM|memROM~6_combout\ & ( ((!\ROM|memROM~1_combout\) # 
-- ((!\CPU|INSTR|PC|DOUT\(0) & !\ROM|memROM~0_combout\))) # (\CPU|INSTR|PC|DOUT\(8)) ) ) ) # ( \ROM|memROM~3_combout\ & ( !\ROM|memROM~6_combout\ & ( (!\ROM|memROM~1_combout\) # (\CPU|INSTR|PC|DOUT\(8)) ) ) ) # ( !\ROM|memROM~3_combout\ & ( 
-- !\ROM|memROM~6_combout\ & ( ((!\ROM|memROM~0_combout\) # (!\ROM|memROM~1_combout\)) # (\CPU|INSTR|PC|DOUT\(8)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111110101111111110101010111111111110101011111111101010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \CPU|INSTR|PC|ALT_INV_DOUT\(8),
...
\DECODER_BLOCKS|Equal6~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER_BLOCKS|Equal6~3_combout\ = ( \CPU|INSTR|PC|DOUT\(0) & ( (\ROM|memROM~5_combout\ & (!\CPU|INSTR|PC|DOUT\(3) & (\CPU|INSTR|PC|DOUT\(2) & !\CPU|INSTR|PC|DOUT\(1)))) ) ) # ( !\CPU|INSTR|PC|DOUT\(0) & ( (\ROM|memROM~5_combout\ & 
-- ((!\CPU|INSTR|PC|DOUT\(3) & (\CPU|INSTR|PC|DOUT\(2) & \CPU|INSTR|PC|DOUT\(1))) # (\CPU|INSTR|PC|DOUT\(3) & (!\CPU|INSTR|PC|DOUT\(2))))) ) )
...
PORT MAP (
	...
	datad => \CPU|INSTR|PC|ALT_INV_DOUT\(1),
	datae => \CPU|INSTR|PC|ALT_INV_DOUT\(0),
	combout => \DECODER_BLOCKS|Equal6~3_combout\);

\DECODER_ADDR|Equal6~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER_ADDR|Equal6~1_combout\ = ( !\ROM|memROM~3_combout\ & ( \ROM|memROM~6_combout\ & ( (!\CPU|INSTR|PC|DOUT\(8) & (!\CPU|INSTR|PC|DOUT\(0) & (\ROM|memROM~0_combout\ & \ROM|memROM~1_combout\))) ) ) ) # ( !\ROM|memROM~3_combout\ & ( 
-- !\ROM|memROM~6_combout\ & ( (!\CPU|INSTR|PC|DOUT\(8) & (\ROM|memROM~0_combout\ & \ROM|memROM~1_combout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000001010000000000000000000000000000010000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \CPU|INSTR|PC|ALT_INV_DOUT\(8),
...
-- Equation(s):
-- \DECODER_ADDR|Equal6~2_combout\ = ( \ROM|memROM~3_combout\ & ( \ROM|memROM~6_combout\ & ( (!\CPU|INSTR|PC|DOUT\(8) & (!\CPU|INSTR|PC|DOUT\(0) & (!\ROM|memROM~0_combout\ & \ROM|memROM~1_combout\))) ) ) ) # ( \ROM|memROM~3_combout\ & ( 
-- !\ROM|memROM~6_combout\ & ( (!\CPU|INSTR|PC|DOUT\(8) & (!\ROM|memROM~0_combout\ & \ROM|memROM~1_combout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000001010000000000000000000000000000010000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \CPU|INSTR|PC|ALT_INV_DOUT\(8),
...
ENABLE_LEDR : cyclonev_lcell_comb
-- Equation(s):
-- \ENABLE_LEDR~combout\ = (\CPU|DECODER|Equal10~0_combout\ & (\DECODER_ADDR|Equal6~0_combout\ & \DECODER_BLOCKS|Equal6~3_combout\))
...
PORT MAP (
	...
	datab => \DECODER_ADDR|ALT_INV_Equal6~0_combout\,
	datac => \DECODER_BLOCKS|ALT_INV_Equal6~3_combout\,
	combout => \ENABLE_LEDR~combout\);
...
-- Equation(s):
-- \LED8|FLIPS|DOUT~0_combout\ = ( \LED8|FLIPS|DOUT~q\ & ( ((!\CPU|DECODER|Equal10~0_combout\) # ((!\DECODER_BLOCKS|Equal6~3_combout\) # (!\DECODER_ADDR|Equal6~1_combout\))) # (\CPU|REG_A|DOUT\(0)) ) ) # ( !\LED8|FLIPS|DOUT~q\ & ( (\CPU|REG_A|DOUT\(0) & 
-- (\CPU|DECODER|Equal10~0_combout\ & (\DECODER_BLOCKS|Equal6~3_combout\ & \DECODER_ADDR|Equal6~1_combout\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000001111111111111110100000000000000011111111111111101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datac => \DECODER_BLOCKS|ALT_INV_Equal6~3_combout\,
	datad => \DECODER_ADDR|ALT_INV_Equal6~1_combout\,
...
-- Equation(s):
-- \LED9|FLIPS|DOUT~0_combout\ = ( \LED9|FLIPS|DOUT~q\ & ( ((!\CPU|DECODER|Equal10~0_combout\) # ((!\DECODER_BLOCKS|Equal6~3_combout\) # (!\DECODER_ADDR|Equal6~2_combout\))) # (\CPU|REG_A|DOUT\(0)) ) ) # ( !\LED9|FLIPS|DOUT~q\ & ( (\CPU|REG_A|DOUT\(0) & 
-- (\CPU|DECODER|Equal10~0_combout\ & (\DECODER_BLOCKS|Equal6~3_combout\ & \DECODER_ADDR|Equal6~2_combout\))) ) )
...
PORT MAP (
	...
	datab => \CPU|DECODER|ALT_INV_Equal10~0_combout\,
	datac => \DECODER_BLOCKS|ALT_INV_Equal6~3_combout\,
	datad => \DECODER_ADDR|ALT_INV_Equal6~2_combout\,
...
\DECODER_BLOCKS|Equal6~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER_BLOCKS|Equal6~1_combout\ = ( \CPU|INSTR|PC|DOUT\(0) & ( (\ROM|memROM~5_combout\ & (!\CPU|INSTR|PC|DOUT\(3) & (\CPU|INSTR|PC|DOUT\(2) & \CPU|INSTR|PC|DOUT\(1)))) ) )
...
PORT MAP (
	...
	datad => \CPU|INSTR|PC|ALT_INV_DOUT\(1),
	datae => \CPU|INSTR|PC|ALT_INV_DOUT\(0),
	combout => \DECODER_BLOCKS|Equal6~1_combout\);

\DECODER_BLOCKS|Equal6~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER_BLOCKS|Equal6~0_combout\ = ( \CPU|INSTR|PC|DOUT\(0) & ( (\ROM|memROM~5_combout\ & (\CPU|INSTR|PC|DOUT\(3) & (!\CPU|INSTR|PC|DOUT\(2) & !\CPU|INSTR|PC|DOUT\(1)))) ) )
...
PORT MAP (
	...
	datad => \CPU|INSTR|PC|ALT_INV_DOUT\(1),
	datae => \CPU|INSTR|PC|ALT_INV_DOUT\(0),
	combout => \DECODER_BLOCKS|Equal6~0_combout\);

\DECODER_BLOCKS|SAIDA[5]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER_BLOCKS|SAIDA[5]~0_combout\ = (\CPU|INSTR|PC|DOUT\(0) & (\ROM|memROM~5_combout\ & (\ROM|memROM~10_combout\ & \ROM|memROM~6_combout\)))
...
PORT MAP (
	...
	combout => \DECODER_BLOCKS|SAIDA[5]~0_combout\);

\DECODER_ADDR|Equal6~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER_ADDR|Equal6~3_combout\ = ( \ROM|memROM~3_combout\ & ( \ROM|memROM~6_combout\ & ( (!\CPU|INSTR|PC|DOUT\(8) & (!\CPU|INSTR|PC|DOUT\(0) & (\ROM|memROM~0_combout\ & \ROM|memROM~1_combout\))) ) ) ) # ( \ROM|memROM~3_combout\ & ( 
-- !\ROM|memROM~6_combout\ & ( (!\CPU|INSTR|PC|DOUT\(8) & (\ROM|memROM~0_combout\ & \ROM|memROM~1_combout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000101000000000000000000000000000001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \CPU|INSTR|PC|ALT_INV_DOUT\(8),
...
-- Equation(s):
-- \DECODER_ADDR|SAIDA[5]~0_combout\ = ( !\ROM|memROM~3_combout\ & ( \ROM|memROM~6_combout\ & ( (!\CPU|INSTR|PC|DOUT\(8) & (\CPU|INSTR|PC|DOUT\(0) & (\ROM|memROM~0_combout\ & \ROM|memROM~1_combout\))) ) ) )
